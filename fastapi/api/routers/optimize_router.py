...
@router.post("/optimize/peak-dispatch-test", response_model=PeakDispatchResponse)
def peak_dispatch_test(req: PeakDispatchRequest):
    ...
    try:
        ...
        record_api_event(endpoint="/optimize/peak-dispatch-test", device_id=None, status_code=400, detail=str(e))
        raise HTTPException(status_code=400, detail=str(e))
    except Exception as e:
        record_api_event(endpoint="/optimize/peak-dispatch-test", device_id=None, status_code=500, detail=str(e))
